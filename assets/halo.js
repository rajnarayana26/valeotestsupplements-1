...
//                     productItemElm.find('[data-value="' + title + '"]').find('label').trigger('click');
                ...
                win.off('resize.sticky').on('resize.sticky', function() {
                    ...
                    stickyResizeTimerId = setTimeout(function() {
                        ...
                        console.log("winWidth: " + winWidth);
                         console.log("curWinWidth: " + curWinWidth);
        ...
        openSearchForm: function () {
            ...
            doc.off('click.hideSearch').on('click.hideSearch', function (e) {
                ...
                // if (!searchForm.is(e.target) && !searchBottom.is(e.target) && !slideshow.has(e.target).length && !searchForm.has(e.target).length && !searchProduct.has(e.target).length && !searchTrending.has(e.target).length && !overlay.has(e.target).length)  {
                //     html.removeClass('search-open');
